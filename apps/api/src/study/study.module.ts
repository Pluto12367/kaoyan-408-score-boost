...
import { LargeQuestionController } from './large-question.controller';
...
@Module({
  ...
  controllers: [StudyController, DailyBriefController, SpriteController, LargeQuestionController],
