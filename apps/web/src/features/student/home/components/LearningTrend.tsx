...
export function LearningTrend({ model }: { model: DashboardViewModel }) {
  ...
  return <section className="dashboard-section dashboard-trend-section" aria-label="最近学习趋势">
    <div className="dashboard-section-heading"><div><span className="dashboard-kicker">Learning Trend</span><h3>最近 7 天</h3></div><span className="dashboard-trend-note"><BarChart3 size={15} /> 每日练习题数</span></div>
