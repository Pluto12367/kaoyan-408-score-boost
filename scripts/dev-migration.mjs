...
// Load .env.development (if present) so local development does not require
// manually exporting DATABASE_URL/AI_API_KEY in every new terminal.
// Values already set in the shell take precedence over the file.
const rootEnvFile = new URL('../.env.development', import.meta.url);
